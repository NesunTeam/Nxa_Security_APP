...
public class ScanView extends View {
    ...
    private Paint mPaintCircleOrLine,mPaintCircleOrLine2,mPaintCircleOrLine3, mPaintArc1, mPaintArc2, mPaintLine;
    ...
    private void initPaint() {
        ...
        mPaintCircleOrLine2 = new Paint();
        mPaintCircleOrLine2.setStrokeWidth(5);
        mPaintCircleOrLine2.setAntiAlias(true);
        mPaintCircleOrLine2.setStyle(Paint.Style.STROKE);
        mPaintCircleOrLine2.setColor(getResources().getColor(R.color.colorCircleOrLine2));


        mPaintCircleOrLine3 = new Paint();
        mPaintCircleOrLine3.setStrokeWidth(3);
        mPaintCircleOrLine3.setAntiAlias(true);
        mPaintCircleOrLine3.setStyle(Paint.Style.STROKE);
        mPaintCircleOrLine3.setColor(getResources().getColor(R.color.colorCircleOrLine3));
    ...
    private void canvasCircle(Canvas canvas) {
        canvas.drawCircle(mWidth / 2, mHeight / 2, (mWidth - getPaddingLeft() - getPaddingRight()) / 6, mPaintCircleOrLine3);
        canvas.drawCircle(mWidth / 2, mHeight / 2, (mWidth - getPaddingLeft() - getPaddingRight()) / 3, mPaintCircleOrLine);
        canvas.drawCircle(mWidth / 2, mHeight / 2, (mWidth - getPaddingLeft() - getPaddingRight()) / 2, mPaintCircleOrLine2);
    }
