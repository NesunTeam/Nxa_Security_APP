    ...
    public void setPointState(int state) {
        ...
        switch (state) {
            case Constant.POINT_STATE_NORMAL:
                this.image.setBackgroundResource(R.mipmap.gesture_node_normal2);
                break;
            case Constant.POINT_STATE_SELECTED:
                this.image.setBackgroundResource(R.mipmap.gesture_node_pressed2);
                break;
            case Constant.POINT_STATE_WRONG:
                this.image.setBackgroundResource(R.mipmap.gesture_node_wrong2);
                break;
            default:
                break;
        }
