...
//            mTvCommit.setText(String.format(getString(R.string.confirm_msg), selectCount, maxCount));
    ...
    private void updateSelectButton(String imagePath) {
        ...
        if (isSelect) {
            mIvPreCheck.setImageDrawable(getResources().getDrawable(R.mipmap.add_applock_select_yes));
        } else {
            mIvPreCheck.setImageDrawable(getResources().getDrawable(R.mipmap.add_applock_select_no));
        }
    }
