    ...
    private void bindMedia(MediaHolder mediaHolder, MediaFile mediaFile) {
        ...
        if (!TextUtils.isEmpty(imagePath)) {
            ...
            if (SelectionManager.getInstance().isImageSelect(imagePath)) {
                ...
                mediaHolder.mImageCheck.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.add_applock_select_yes));
            } else {
                mediaHolder.mImageView.setColorFilter(null);
                mediaHolder.mImageCheck.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.add_applock_select_no));
            }
